...
SECRET_KEY = 'django-insecure-4@0vn!tr#0$%r+v)dw%a@@mtccx@^g&v&m3-w!beh)#3rjlnd9'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ngopinath7$default',
        'USER': 'ngopinath7',
        'PASSWORD': 'kudoshinichi',
...
#Media files will be accessible via URLs starting with /media/
#like http://localhost:8000/media/example.jpg.
